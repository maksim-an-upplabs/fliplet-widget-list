...
SwipeSaveList.prototype.init = function(){
  ...
  // this.saved_list = new PV( 'saved_list_' + this.listSwipe.container.id, this.SAVED_PV_STRUCT, this.restoreSavedList.bind(this), null );
  Fliplet.Storage.get('saved_list_' + this.listSwipe.container.id, {
...
SwipeSaveList.prototype.saveListItem = function(el,i){
  ...
  if ( this.saved_list.saved_indices.indexOf(i) < 0 && i > -1 ) {
    ...
    Fliplet.Storage.set('saved_list_' + this.listSwipe.container.id, this.saved_list);
  }
};
...
SwipeSaveList.prototype.restoreSavedList = function(data) {
  this.saved_list = data || this.SAVED_PV_STRUCT;
